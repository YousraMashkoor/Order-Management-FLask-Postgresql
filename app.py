...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:postgres@localhost/test2'
...
def get_pending_orders():
    ...
    pending_orders = Order.query.filter_by(shipped_date=None).order_by(Order.order_date.desc()).all()
